...
//                    } catch (Exception e) {
//                        Log.e("getWidth", "doInBackground 发生异常");
//                        e.printStackTrace();
//                    }
//                }
//                return null;
...
//                Bitmap bitmap = values[0].getParcelable("bitmap");
//                int i = values[0].getInt("position");
...
////                ultimateStagAdapter.notifyItemInserted(imgList.size() - 1);
////                ultimateStagAdapter.notifyDataSetChanged();
//            }
//
//            @Override
...
//                Log.e("onResponse", "getImageSize 方法执行完毕");
//                recyclerview.setRefreshing(false);
//                ultimateStagAdapter.notifyDataSetChanged();
//            }
//        }.execute();
